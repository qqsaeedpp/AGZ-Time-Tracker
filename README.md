...
پاسخگویی، پشتیبانی، تاریخ امروز و …) را تغییر دهید و برای هر متن یک **ایموجی پریمیوم**
به‌عنوان آیکن ابتدای پیام تنظیم کنید. در مرحلهٔ ایموجی می‌توانید:

- خودِ ایموجی پریمیوم را بفرستید (نیازمند تلگرام پریمیوم برای ارسال)،
- یا `custom_emoji_id` عددی را ارسال کنید،
- یا `-` را بفرستید تا از ایموجی معمولی استفاده شود.

شناسهٔ ایموجی پیش از ذخیره با `get_custom_emoji_stickers` اعتبارسنجی می‌شود؛ در صورت
نامعتبر بودن، خطا نمایش داده می‌شود و دوباره درخواست می‌شود.
