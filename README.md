...
- Python 3.12 · aiogram 3 · SQLAlchemy 2 (async) · PostgreSQL · Alembic · APScheduler
...
```
Telegram ⇄ Bot Layer ⇄ Handlers ⇄ Services ⇄ Repositories ⇄ PostgreSQL
                                      ▲
                          APScheduler (۲۳:۰۰ تهران)
```

- **یک شیفت فعال در هر کاربر** با partial unique index سطح دیتابیس تضمین می‌شود.
...
| `DATABASE_URL` | DSN آسنکرون PostgreSQL (`postgresql+asyncpg://...`) |
